...
with open('rnn_tokeniser.pkl', 'wb') as file:
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.savefig(r'C:\Users\jeena\Desktop\Deep learning\Streamlit App\MODELS\RNN\images\test.jpg')


preds = (rnn_model.predict(padded_test) > 0.5).astype("int32")
